...
def rho_attack(initial_str,collision_length):
    ...
    while True:
        ...
        if initial_hash_f in attack_list:
            ...
            print("碰撞的哈希值：{}\t{}".format(h_sm3(attack_list[attack_list.index(initial_hash_f)-1]),initial_hash_s2))
            break
        else:
            attack_list.append(initial_hash_f)
